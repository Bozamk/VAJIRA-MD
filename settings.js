...
global.owner = process.env.OWNER_NUMBER  || '94773127200' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=bNd3HJxR#otVMp4pocmJXdRWnOkfKNnuHzxNltc8eFROFpMgiFtk' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || '𝚂𝙰𝚃𝙷𝙼𝙸𝙽 𝙾𝙵𝙲©' ,
